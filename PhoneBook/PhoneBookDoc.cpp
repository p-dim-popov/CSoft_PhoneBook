...
CPhoneBookDoc::CPhoneBookDoc() noexcept
{
...
void CPhoneBookDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CPhoneBookDoc::InitializeSearchContent()
{
...
void CPhoneBookDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
