...
/// <summary>Изглед клас за PHONE_TYPES</summary>
...
private:
	...
	/// <returns>Указател към документа - CPhoneTypesDocument
...
#pragma endregion ContextMenuOptions
	...
	INT GetPhoneTypeIndexInListCtrlByItemData(DWORD_PTR dwData) const;

#pragma region OnUpdateCases
	/// <summary>Вмъква нов град в ListCtrl при сигнал за създаване</summary>
	/// <param name="dwPhoneTypeItemData"> входящата информация от документа </param>
	void UpdateOnOperationCreate(const DWORD_PTR dwPhoneTypeItemData);
	/// <summary>Ъпдейтва град от ListCtrl при сигнал за ъпдейт</summary>
	/// <param name="dwPhoneTypeItemData">входящата информация от документа</param>
	void UpdateOnOperationUpdate(const DWORD_PTR dwPhoneTypeItemData);
	/// <summary>Изтрива град от ListCtrl при сигнал за изтриване</summary>
	/// <param name="dwPhoneTypeItemData">входящата информация от документа</param>
	void UpdateOnOperationDelete(const DWORD_PTR dwPhoneTypeItemData);
